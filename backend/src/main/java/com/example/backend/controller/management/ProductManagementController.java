...
public class ProductManagementController {
    ...
    public APIResponse<List<ProductAttributeValueResponse>> getAttributesByProductId(
    ...
    public APIResponse<ProductAttributeValueResponse> addAttributeToProduct(
        ...
        ProductAttributeValueResponse response = productService.addAttributeToProduct(productId, request);
    ...
    public APIResponse<ProductAttributeValueResponse> updateProductAttribute(
            ...
            @Valid @RequestBody ProductAttributeValueRequest request) {
        return APIResponse.success(productService.updateProductAttribute(attributeId, request));
    }
    ...
    public APIResponse<List<VariantSimpleResponse>> searchSimpleVariants(
            ...
            @RequestParam(name = "limit", defaultValue = "20") int limit // Mặc định trả về 20 kết quả để chống quá tải
    ) {
        return APIResponse.success(productVariantService.searchSimpleVariantsForDropdown(keyword, limit));
    }

    @GetMapping("/{productId}/variants")
    public APIResponse<List<ProductVariantResponse>> getVariantsByProduct(
            @PathVariable Integer productId) {
