...
export default function FloatingChatBot({isOpen, onOpen, onClose }) {
 ...
 return (
    // 1. CHUYỂN GỐC TỌA ĐỘ XUỐNG DƯỚI: Dùng bottom-24 (cách đáy 96px) để icon nằm ngay trên icon chat thường
    <div className="fixed bottom-24 right-3 sm:right-6 z-[9999] font-sans">
      ...
      >
        ...
        <div 
          ...
          className={`absolute right-0 bottom-[calc(50dvh-6rem)] translate-y-1/2 w-[calc(100vw-32px)] sm:w-[450px] lg:w-[400px] h-[75dvh] max-h-[600px] flex flex-col bg-white rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 origin-bottom-right ${
