...
import { Tag, Popconfirm, Image, Space, Tooltip } from 'antd';
...
export default function ArticleManagement() {
    ...
    },
    {
      ...
      render: (_, record) => (
        <div className="flex flex-col gap-1.5 py-1">
          <Tooltip title={record.title} placement="topLeft" mouseEnterDelay={0.2}>
            <span className="font-bold text-slate-800 text-[15px] leading-snug hover:text-indigo-600 transition-colors cursor-pointer line-clamp-3 break-words w-110">
              {record.title}
            </span>
          </Tooltip>
  ...
  return (
    <>
      <SEO title='Quản lý tin tức' noIndex/>
