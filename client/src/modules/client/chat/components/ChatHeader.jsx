...
export default function ChatHeader({ onNewChat, onClose, onMouseDown }) {
  return (
    <div 
      ...
      className="bg-gradient-to-r from-blue-600 to-cyan-500 p-2 flex items-center justify-between shrink-0 cursor-move select-none rounded-t-2xl"
    >
      <div className="flex items-center gap-2 text-white pointer-events-none">
        ...
        <div className="flex flex-col">
          <h3 className="font-bold text-[16px] leading-tight flex items-center gap-1.5 drop-shadow-sm">
            Trợ lý AI TechStore <Sparkles size={14} className="text-yellow-300" />
          </h3>
