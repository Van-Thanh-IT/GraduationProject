...
const AboutPage = () => {
  return (
    <>
      <SEO
        title="Giới thiệu"
        description="TechStore là cửa hàng chuyên cung cấp thiết bị công nghệ chính hãng như điện thoại, laptop, phụ kiện với giá tốt và dịch vụ uy tín."
        url="https://techstores-two.vercel.app/abouts"
        type="website"
      />
