...
const categoryMap = {
  ...
  "am-thanh": "Âm thânh",
  "phu-kien": "Phụ kiện",
  "linh-kien-may-tinh": "Linh kiện mấy tính"
};
...
export default function ProductPage() {
  ...
  const dynamicTitle = categoryName
    ? `${categoryName} ${brandName ? brandName : ""} chính hãng`
    : "Sản phẩm công nghệ chính hãng";

    const dynamicDescription = categoryName
  ? `Mua ${categoryName.toLowerCase()} ${brandName ? brandName : ""} chính hãng tại TechStore. Giá tốt, bảo hành uy tín, giao hàng toàn quốc.`
  : "Khám phá các sản phẩm công nghệ chính hãng tại TechStore.";
