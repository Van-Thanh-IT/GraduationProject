...
const CustomerChatWidget = ({isOpen, onOpen, onClose}) => {
    ...
    return (
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[999] font-sans">
            ...
            {isOpen && (
                <div className="w-[calc(100vw-32px)] sm:w-[380px] h-[500px] sm:h-[550px] max-h-[75vh] sm:max-h-[80vh] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200 animate-slide-up">
                    
                    <div className="bg-blue-600 p-2 text-white flex items-center justify-between shrink-0">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                                <MessageCircle className="w-6 h-6" />
                            </div>
                            <div>
                                <h3 className="font-bold text-base">Nhân Viên CSKH</h3>
                                <p className="text-[14px] text-blue-100 opacity-90">
